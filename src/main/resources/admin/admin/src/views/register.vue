    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">手机销售网站注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="星级信誉" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaXingjiTypes" autocomplete="off" placeholder="星级信誉"  />
                           </el-form-item>
                        -->
                        <!--
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/shoujixiaoshou/img/back-img-bg.jpg);
