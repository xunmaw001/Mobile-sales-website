        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="星级信誉" prop="shangjiaXingjiTypes">
                        <el-select v-model="ruleForm.shangjiaXingjiTypes" :disabled="ro.shangjiaXingjiTypes" placeholder="请选择星级信誉">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="星级信誉" prop="shangjiaXingjiValue">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaXingjiTypes: [
                              { required: true, message: '星级信誉不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
